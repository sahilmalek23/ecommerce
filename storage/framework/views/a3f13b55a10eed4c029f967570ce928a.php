    ...
    <div class="container mb-5">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                ...
                <?php if($order->bill_firstname != $order->firstname || $order->bill_address != $order->address): ?>
                <div class="order-details">
                ...
                <div class="text-center mt-5">
                    <a href="<?php echo e(route('home')); ?>" class="genric-btn primary circle arrow">Continue Shopping</a>
                </div>
            </div>
        </div>
    </div>
<?php $__env->stopSection(); ?> 
<?php echo $__env->make('website.layout.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\XAMPP\htdocs\ecommerce-app\resources\views/website/order-confirmation.blade.php ENDPATH**/ ?>