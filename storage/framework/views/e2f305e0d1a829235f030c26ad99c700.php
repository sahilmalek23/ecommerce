<footer>
                    ...
                    <div class="single-footer-caption mb-50">
                        <div class="single-footer-caption mb-30">
                            ...
                            <div class="footer-logo mb-35">
                                <a href="javascript:void(0)"><img src="<?php echo e(asset('website')); ?>/img/logo/logo2_footer.png"
                                        alt=""></a>
                            </div>
                    ...
                    <div class="col-xl-12 ">
                        <div class="footer-copy-right text-center">
                            <p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                                Copyright &copy;
                                <?php echo e(now()->format('Y')); ?> All rights reserved 
    ...
    <!-- Footer End-->
</footer><?php /**PATH D:\XAMPP\htdocs\ecommerce-app\resources\views/website/layout/footer.blade.php ENDPATH**/ ?>