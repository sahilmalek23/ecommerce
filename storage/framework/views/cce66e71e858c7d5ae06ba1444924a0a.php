...
<div class="col-12">
  ...
  <div class="card-deck">                
    <div class="card shadow mb-4">                  
      <div class="card-body">
        <form action="<?php echo e(route('admin.product.categroy.submit')); ?>" method="post" enctype="multipart/form-data">
          <?php echo csrf_field(); ?>
          <input type="hidden" name="editId" value="<?php echo e($editId); ?>">
          <div class="form-group row">
            <label for="inputEmail3" class="col-sm-3 col-form-label">Title</label>
            <div class="col-sm-9">
              <input type="text" class="form-control" value="<?php echo e($title); ?>" name="title" id="title" placeholder="Title">
            </div>
          </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\XAMPP\htdocs\ecommerce-app\laravelpro\resources\views/admin/categroy-form.blade.php ENDPATH**/ ?>