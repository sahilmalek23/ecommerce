...
<?php $__env->startSection('main'); ?>
    ...
    <div class="container">
        <?php if($cartList->isNotEmpty()): ?>
            <form action="<?php echo e(route('purchase')); ?>" method="post" id="checkout">
                 <?php echo csrf_field(); ?>
                <div class="row mb-40">
                    <div class="col-lg-8">
                            ...
                            <div class="col-md-4 col-sm-6 mb-3">
                                <div class="mb-2 form-group">
                                    <select class="form-control" id="state"  name="state">
                                        ...
                                        <?php $__currentLoopData = $indiaRegions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $state): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="col-lg-4">
                        ...
                        <input type="hidden" name="promocode" value="<?php echo e(request('promocode')); ?>">
                        <hr>
                        <div class=" d-flex">
                            <span class="atcp-img position-relative">
                                <span class="qtybage"><?php echo e($item->qty); ?></span>
                                <img src="<?php echo e(asset('storage/'. $item->image)); ?>" alt="" class="addtimg" width="80px">
                            </span>
                            <div class="ml-4 flex-fill">
                                <div class="d-flex">
                                    <h3 class="font-weight-bold flex-fill "><?php echo e($item->name); ?></h3>                                
                                </div>
                                <p class="m-0">Size: <span><?php echo e($item->size); ?></span></p>
                                <div class="d-flex">
                                    <p class="mb-0 flex-fill align-self-center pt-3">&#8377; <?php echo e($item->dp); ?></p>                        
                                </div>
                            </div>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="d-flex mt-5">
                            ...
                            <p class=""><b>&#8377; <?php echo e($subtotal); ?></b></p>
                        </div>
                        <div class="d-flex">
                            <p class="flex-fill">Discount</p>
                            <p class=""><b>&#8377; <?php echo e($discount); ?></b></p>
                        </div>
                        <div class="d-flex border-bottom">
                            <p class="flex-fill">Delivery Fee</p>
                            <p class=""><b>&#8377; <?php echo e($deliveryFee); ?></b></p>
                        </div>

                        <div class="d-flex mt-3">
                            <p class="flex-fill">Total</p>
                            <p class=""><b>&#8377; <?php echo e($total); ?></b></p>
                        </div>
...
<script src="<?php echo e(asset('website/js/custom/checkout.js')); ?>"></script>
...
function PaymentFunction(orderInfo) {
    ...
    var options = {
        ...
        "image": "<?php echo e(asset('assets/images/logo.svg')); ?>", //The image should be a 128x128px logo
...
function VerifyPaymentStatus(paymentResponse) {
    paymentResponse._token = "<?php echo e(csrf_token()); ?>";
    console.log(paymentResponse);
    
    $.ajax({
        url: "<?php echo e(route('purchase.verify.payment')); ?>",
        method: 'POST',
        async: false,
        data: paymentResponse,
        success: function(response) {   

            window.location.href = "<?php echo e(route('order.confirmation','/')); ?>/" + response.invoicemasterid;
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('website.layout.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\XAMPP\htdocs\ecommerce-app\resources\views/website/checkout.blade.php ENDPATH**/ ?>