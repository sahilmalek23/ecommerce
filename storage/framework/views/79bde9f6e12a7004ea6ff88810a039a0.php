...
<?php $__env->startSection('main'); ?>
    ...
    <div class="container">
        <?php if(session('cart_warning')): ?>
            <div class="alert alert-warning" role="alert">
                <?php echo e(session('cart_warning')); ?>

            </div>
        <?php endif; ?>
        <div class="row mb-40">
            <div class="col-lg-8">
                <?php $__currentLoopData = $InvoiceDetail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $InvoiceProduct): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <hr>
                <div class=" d-flex">
                    <span class="atcp-img"><img src="<?php echo e(asset('storage/'. $InvoiceProduct->image)); ?>" alt="" class="addtimg"
                            width="80px"></span>
                    <div class="ml-4 flex-fill">
                        <div class="d-flex">
                            <h3 class="font-weight-bold flex-fill "><?php echo e($InvoiceProduct->name); ?></h3>
                            <div>
                                <a href="<?php echo e(route('cart.item.delete', ['psid' => $InvoiceProduct->psid])); ?>">
                        ...
                        <p class="m-0">Size: <span><?php echo e($InvoiceProduct->size); ?></span></p>
                        <div class="d-flex">
                            <p class="mb-0 flex-fill align-self-center pt-3">&#8377; <?php echo e($InvoiceProduct->dp); ?></p>
                            <div class="qty-sec add-button float-right mt-3" data-psid="<?php echo e($InvoiceProduct->psid); ?>">
                                <button
                                    class="qty-decrement qty-btn px-4 border-radius-left small cu-font-size active genric-btn primary">-</button>
                                <input type="text" class="qty-input" value="<?php echo e($InvoiceProduct->qty); ?>" spellcheck="false" data-ms-editor="true">
                                <button
            ...
            <?php if($InvoiceDetail->isNotEmpty()): ?>
                <?php
                ...
                <div class="col-lg-4">
                    ...
                    <div class="d-flex mt-5">
                        ...
                        <p class=""><b>&#8377; <span id="subtotal"><?php echo e($subtotal); ?></span></b></p>
                    </div>
                    <div class="d-flex">
                        <p class="flex-fill">Discount</p>
                        <p class=""><b>&#8377; <span id="discount"><?php echo e($discount); ?></span></b></p>
                    </div>
                    <div class="d-flex border-bottom">
                        <p class="flex-fill">Delivery Fee</p>
                        <p class=""><b>&#8377;  <span id="deliveryFee"><?php echo e($deliveryFee); ?></span></b></p>
                    </div>

                    <div class="d-flex mt-3">
                        <p class="flex-fill">Total</p>
                        <p class=""><b>&#8377; <span id="total"><?php echo e($total); ?></span></b></p>
                    </div>
        ...
        <?php if($InvoiceDetail->isEmpty()): ?>
            <div class="text-center mb-10">
                <hr>
                <h4>Your cart is empty.</h4>
                <a href="<?php echo e(route('shop')); ?>" class="genric-btn primary circle arrow mt-3">Continue Shopping</a>
            </div>
        <?php endif; ?>
    </div>
...
$(document).ready(function() {
    function updateCartQuantity(psid, qty, element) {
        ...
        $.ajax({
            url: '<?php echo e(route("cart.update.qty")); ?>',
            method: 'POST',
            async: false,
            data: {
    ...
    $('#apply-promo-btn').on('click', function(e) {
        ...
        $.ajax({
            url: '<?php echo e(route("cart.apply.promo")); ?>',
            method: 'POST',
            data: {
                _token: '<?php echo e(csrf_token()); ?>',
                promocode: promoCode
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('website.layout.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\XAMPP\htdocs\ecommerce-app\resources\views/website/cart.blade.php ENDPATH**/ ?>